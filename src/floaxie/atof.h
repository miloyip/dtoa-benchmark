...
inline value_and_status<FloatType>
atof(const CharType *str, CharType **str_end,
     FallbackCallable fallback_func = default_fallback<FloatType, CharType>) {
...
template <typename FloatType, typename CharType,
          typename FallbackCallable = FloatType(const CharType *, CharType **)>
inline value_and_status<FloatType>
atof(const CharType *str, std::nullptr_t str_end,
     FallbackCallable fallback_func = default_fallback<FloatType, CharType>) {
  return atof<FloatType, CharType, FallbackCallable>(
      str, static_cast<CharType **>(str_end), fallback_func);
}
...
template <typename FloatType, typename CharType,
          typename FallbackCallable = FloatType(const CharType *, CharType **)>
inline value_and_status<FloatType> from_string(
