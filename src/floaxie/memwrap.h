...
inline CharType *memset(CharType *dest, CharType ch, std::size_t count);
...
template <>
inline wchar_t *memset(wchar_t *dest, wchar_t ch, std::size_t count) {
 ...
 */
template <typename CharType>
inline CharType *memmove(CharType *dest, const CharType *src,
                         std::size_t count);

template <>
inline char *memmove(char *dest, const char *src, std::size_t count) {
  return static_cast<char *>(std::memmove(dest, src, count));
}

template <>
inline wchar_t *memmove(wchar_t *dest, const wchar_t *src, std::size_t count) {
